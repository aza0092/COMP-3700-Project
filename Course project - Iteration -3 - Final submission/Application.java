...
public class Application 
{
    ...
    private ViewReportsController viewReportsController;
    
    public ViewReportsController viewReportsController() {
    ...
    private Application() {
        ...
        try {
            ...
            //ResultSet userTables = dbm.getTables(null, null, "users", null);
            if (tables.next()) {
              // Table exists
            }
            else {
       ...
       passwordChangeController = new PasswordChangeController(passwordChange, dataAdapter);
       
       newUserController = new NewUserController(newUser, dataAdapter);
       
       viewReportsController = new ViewReportsController(viewReports, dataAdapter);
    }

...
public class DataAdapter 
{
    ...
    public boolean saveProduct(Product product) 
    {
        try {
            ...
            if (resultSet.next()) 
            {
                statement = connection.prepareStatement("UPDATE product SET Name = ?, Price = ?, Quantity = ?, Tax = ? WHERE ProductID = ?");
            ...
            { 
               ...
               // statement.setDouble(5, product.getTax()); /*here*/
            }
            statement.execute();
          //  resultSet.close();
         //   statement.close();
    ...
    public Order loadOrder(int id) 
    {
        try {
            ...
            while (resultSet.next()) 
            {
                ...
                //line.setTax(resultSet.getDouble(5)); /*here*/
                order.addLine(line);
            }
        ...
        try {
           ...
           // statement.setDouble(5, order.getTotalTax());
            ...
            for (OrderLine line: order.getLines()) { // store for each order line
               ...
               // statement.setDouble(5, line.getTax()); /*here*/

...
public class Application 
{
    ...
    private void initializeDatabase(Statement stmt) throws SQLException {
        ...
        String products = "create table product (ProductID integer,name varchar(100), price double,  quantity integer, tax double, primary key (ProductID))";
                       
        String orders = "create table orders (orderID integer, date varchar(100), total double, primary key (orderID))";
                     
        String orderLine = "create table orderline (orderID integer, productID integer, qty integer, total double, primary key(orderID, productID))"; 
